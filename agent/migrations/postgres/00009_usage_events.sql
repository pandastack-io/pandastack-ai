...
CREATE TABLE IF NOT EXISTS usage_events (
    ...
    gb_seconds DOUBLE PRECISION DEFAULT 0,
...
ALTER TABLE workspaces ADD COLUMN IF NOT EXISTS monthly_cpu_seconds_max BIGINT DEFAULT 0;
ALTER TABLE workspaces ADD COLUMN IF NOT EXISTS monthly_budget_micros BIGINT DEFAULT 0;
